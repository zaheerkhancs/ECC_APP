...
namespace IOM.ECCMS.ECCDB
{
	...
	public abstract class aspnet_RolesCollection_Base
	{
		...
		public aspnet_RolesCollection_Base(ECCMS db)
		{
			_db = db;
		}
		...
		/// by the <c>FK__aspnet_Ro__Appli__6754599E</c> foreign key.
		/// </summary>
		...
		/// return records by the <c>FK__aspnet_Ro__Appli__6754599E</c> foreign key.
		/// </summary>
		/// <param name="applicationId">The <c>ApplicationId</c> column value.</param>
		/// <returns>A reference to the <see cref="System.Data.IDbCommand"/> object.</returns>
		...
		/// <c>FK__aspnet_Ro__Appli__6754599E</c> foreign key.
		/// </summary>
		/// <param name="applicationId">The <c>ApplicationId</c> column value.</param>
		...
		/// <summary>
		/// Creates an <see cref="System.Data.IDbCommand"/> object that can be used to
		/// delete records using the <c>FK__aspnet_Ro__Appli__6754599E</c> foreign key.
		/// </summary>
		/// <param name="applicationId">The <c>ApplicationId</c> column value.</param>
		/// <returns>A reference to the <see cref="System.Data.IDbCommand"/> object.</returns>
