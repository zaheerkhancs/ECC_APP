...
namespace ECC_App
{
    public partial class _ComplaintTypeRPT : ECC.BaseController.BaseController 
    {
        ...
        private DataTable GetGridData()
        {
            ...
            try
            {
                ...
                dt = _objList.getStaticReport_Compalint ();
        ...
        protected void lnkPDF_Click(object sender, EventArgs e)
        {
            ...
            {
                {
                    rep.Load(Server.MapPath("~\\Reports\\_ComplaintTypeReport.rpt"));
