...
namespace ECC_App
{
    public partial class Complaint_ComplainType : ECC.BaseController.BaseController
    {
        ...
        private DataTable GetGridData(int ProvID)
        {
            ...
            try
            {
                ...
                dt = _objList.getByComplainType(ProvID);
                if (dt.Rows.Count == 0)
        ...
        protected void lnkPDF_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    rep.Load(Server.MapPath("~\\Reports\\Complain_ComplainType_RPT.rpt"));
