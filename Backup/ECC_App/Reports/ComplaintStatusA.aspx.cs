...
namespace ECC_App
{
    public partial class ComplaintStatusA : ECC.BaseController.BaseController
    {
        ...
        private DataTable GetGridData(int ProvID)
        {
            ...
            try
            {
                ...
                dt = _objList.getByComplaintStatusA(ProvID,1);
                if (dt.Rows.Count == 0)
        ...
        protected void lnkPDF_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    rep.Load(Server.MapPath("~\\Reports\\ComplaintStatusA_RPT.rpt"));
