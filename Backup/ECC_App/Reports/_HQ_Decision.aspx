<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MasterPages/MainPage.Master"  CodeBehind="_HQ_Decision.aspx.cs" Inherits="ECC_App._HQ_Decision" %>
  ...
  <tr>
   <td>
       <asp:GridView ID="_gvList" runat="server" AllowPaging="True" 
           ...
           onsorting="_gvList_Sorting" Width="100%">
           <Columns>
               ...
               <asp:BoundField DataField="AllagType_Name" HeaderText="Allegation" />
