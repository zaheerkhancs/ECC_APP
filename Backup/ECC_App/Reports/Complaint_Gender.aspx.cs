...
namespace ECC_App
{
    public partial class Complaint_Gender : ECC.BaseController.BaseController
    {
        ...
        private DataTable GetGridData(int ProvID)
        {
            ...
            try
            {
                ...
                dt = _objList.getByComplainGender(ProvID);
                if (dt.Rows.Count == 0)
        ...
        protected void lnkPDF_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    rep.Load(Server.MapPath("~\\Reports\\Complaint_Gender_RPT.rpt"));
