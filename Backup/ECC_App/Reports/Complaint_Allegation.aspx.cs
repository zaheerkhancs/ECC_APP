...
namespace ECC_App
{
    public partial class Complaint_Allegation : ECC.BaseController.BaseController 
    {
        ...
        private DataTable GetGridData(int ProvID)
        {
            ...
            try
            {
                ...
                dt = _objList.getByComplainAllegation(ProvID);
        ...
        protected void lnkPDF_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    rep.Load(Server.MapPath("~\\Reports\\Complaint_Allegation_RPT.rpt"));
