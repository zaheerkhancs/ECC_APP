...
namespace ECC_App
{
    public partial class Complaint_Candidate : ECC.BaseController.BaseController 
    {
        ...
        private DataTable GetGridData(int ProvID)
        {
            ...
            try
            {
                ...
                dt = _objList.getByCandidate(ProvID);
        ...
        protected void lnkPDF_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    rep.Load(Server.MapPath("~\\Reports\\Complaint_Candidate_RPT.rpt"));
