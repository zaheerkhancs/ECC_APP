...
namespace IOM.ECCMS.ECCDB
{
	...
	public abstract class aspnet_PersonalizationAllUsersCollection_Base
	{
		...
		public aspnet_PersonalizationAllUsersCollection_Base(ECCMS db)
		{
			_db = db;
		}
		...
		/// by the <c>FK__aspnet_Pe__PathI__6383C8BA</c> foreign key.
		/// </summary>
		/// <param name="pathId">The <c>PathId</c> column value.</param>
		/// <returns>An array of <see cref="aspnet_PersonalizationAllUsersRow"/> objects.</returns>
		...
		/// return records by the <c>FK__aspnet_Pe__PathI__6383C8BA</c> foreign key.
		/// </summary>
		/// <param name="pathId">The <c>PathId</c> column value.</param>
		/// <returns>A reference to the <see cref="System.Data.IDbCommand"/> object.</returns>
		...
		/// <c>FK__aspnet_Pe__PathI__6383C8BA</c> foreign key.
		/// </summary>
		/// <param name="pathId">The <c>PathId</c> column value.</param>
		...
		/// <summary>
		/// Creates an <see cref="System.Data.IDbCommand"/> object that can be used to
		/// delete records using the <c>FK__aspnet_Pe__PathI__6383C8BA</c> foreign key.
		/// </summary>
		/// <param name="pathId">The <c>PathId</c> column value.</param>
		/// <returns>A reference to the <see cref="System.Data.IDbCommand"/> object.</returns>
