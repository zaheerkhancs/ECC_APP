<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MasterPages/MainPage.Master" CodeBehind="Complaint_Gender.aspx.cs" Inherits="ECC_App.Complaint_Gender" %>
    ...
    <table style="width: 100%;">
        <tr>
            <td style="background-color: #293A27">
                <span class="style2">Complainant Gender</span>&nbsp; &nbsp; &nbsp;
            </td>
        </tr>
        <tr>
            <td >
        ...
        <tr>
            ...
            <asp:Label ID="lblNoDataMsg" runat="server" 
                ...
                <asp:GridView ID="_gvReport" runat="server" AutoGenerateColumns="False" 
                    ...
                    <Columns>
                        <asp:BoundField DataField="GenderName" HeaderText="Complainant Gender" />
