<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MasterPages/MainPage.Master" CodeBehind="Complaint_Allegation.aspx.cs" Inherits="ECC_App.Complaint_Allegation" %>
    ...
    <table style="width: 100%;">
        <tr>
            <td style="background-color: #293A27">
                <span class="style2">Complain Allegation Type </span>&nbsp; &nbsp; &nbsp;
            </td>
        </tr>
        <tr>
            <td >
...
<asp:Label ID="lblNoDataMsg" runat="server" 
                ...
                <asp:GridView ID="_gvReport" runat="server" AutoGenerateColumns="False" 
                    ...
                    <Columns>
                        <asp:BoundField DataField="AllagType_Name" HeaderText="Complain Allegation" />
