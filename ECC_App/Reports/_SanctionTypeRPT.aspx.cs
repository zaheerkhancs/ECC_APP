...
namespace ECC_App
{
    public partial class _SanctionTypeRPT : ECC.BaseController.BaseController 
    {
        ...
        private DataTable GetGridData()
        {
            ...
            try
            {
                ...
                dt = _objList.getStaticReport_Sanction ();
        ...
        protected void lnkPDF_Click(object sender, EventArgs e)
        {
            ...
            {
                {
                    rep.Load(Server.MapPath("~\\Reports\\_SanctionTypeReport.rpt"));
