...
namespace ECC_App
{
    public partial class _StatusTypeRPT : ECC.BaseController.BaseController 
    {
        ...
        private DataTable GetGridData()
        {
            ...
            try
            {
                ...
                dt = _objList.getStaticReport_Status ();
        ...
        protected void lnkPDF_Click(object sender, EventArgs e)
        {
            ...
            {
                {
                    rep.Load(Server.MapPath("~\\Reports\\_StatusTypeReport.rpt"));
