<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile ="~/MasterPages/MainPage.Master" CodeBehind="Complaint_Status.aspx.cs" Inherits="ECC_App.Complaint_Status" %>
    ...
    <table style="width: 100%;" width="100%">
        <tr>
            <td style="background-color: #293A27">
                <span class="style2">Complain Status </span>&nbsp; &nbsp; &nbsp;
            </td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <asp:Label ID="lblNoDataMsg" runat="server" 
                ...
                <asp:GridView ID="_gvReport" runat="server" AutoGenerateColumns="False" 
                    ...
                    <Columns>
                        <asp:BoundField DataField="StatusName" HeaderText="Complaint Status" />
