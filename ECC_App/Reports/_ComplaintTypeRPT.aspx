<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MasterPages/MainPage.Master"
    CodeBehind="_ComplaintTypeRPT.aspx.cs" Inherits="ECC_App._ComplaintTypeRPT" %>
    ...
    <table style="width: 100%;">
                ...
                <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                    <ContentTemplate>
                        <table style="width: 585px" align="center">
                            <tr>
                                <td>
                                    <asp:Label ID="lblNoDataMsg" runat="server" Style="color: #FF0000; font-size: small;
                                        font-weight: 700;"></asp:Label>
                                    <asp:GridView ID="_gvReport" runat="server" AutoGenerateColumns="False" Style="text-align: center;
                                        font-size: small" Width="93%">
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="IEC">
                                                <ItemTemplate>
                                                    <asp:Label ID="Label6" runat="server" Text='<%# Bind("IEC") %>'></asp:Label>
                                                </ItemTemplate>
                                                <EditItemTemplate>
                                                    <asp:TextBox ID="TextBox6" runat="server" Text='<%# Bind("IEC") %>'></asp:TextBox>
                                                </EditItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="FEFA">
                                                <ItemTemplate>
                                                    <asp:Label ID="Label7" runat="server" Text='<%# Bind("FEFA") %>'></asp:Label>
                                                </ItemTemplate>
                                                <EditItemTemplate>
                                                    <asp:TextBox ID="TextBox7" runat="server" Text='<%# Bind("FEFA") %>'></asp:TextBox>
                                                </EditItemTemplate>
                                            </asp:TemplateField>
                                            ...
                                            <asp:TemplateField HeaderText="Individual">
                                                ...
                                                <EditItemTemplate>
                                                    <asp:TextBox ID="TextBox10" runat="server" Text='<%# Bind("Individual") %>'></asp:TextBox>
                                                </EditItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="Other/UnKnown">
                                                ...
                                                <EditItemTemplate>
                                                    <asp:TextBox ID="TextBox11" runat="server" Text='<%# Bind("Others") %>'></asp:TextBox>
                                                </EditItemTemplate>
                                            </asp:TemplateField>
        ...
        <tr>
            <td style="text-align: center">
                <asp:LinkButton ID="lnkPDF" runat="server" Style="font-weight: 700; font-size: small"
                    OnClick="lnkPDF_Click">Export to 
                PDF |</asp:LinkButton>
                <asp:LinkButton ID="lnkExcel" runat="server" Style="font-weight: 700; font-size: small"
                    OnClick="lnkExcel_Click">Export 
