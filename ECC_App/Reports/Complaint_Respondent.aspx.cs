...
namespace ECC_App
{
    public partial class Complaint_Respondent : ECC.BaseController.BaseController
    {
        ...
        private DataTable GetGridData(int ProvID)
        {
            ...
            try
            {
                ...
                dt = _objList.getByComplaintRespondent(ProvID);
                if (dt.Rows.Count == 0)
        ...
        protected void lnkPDF_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    rep.Load(Server.MapPath("~\\Reports\\Complaint_Respondent_RPT.rpt"));
