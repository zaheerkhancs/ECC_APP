<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MasterPages/MainPage.Master" CodeBehind="Complaint_Candidate.aspx.cs" Inherits="ECC_App.Complaint_Candidate" %>
    ...
    <table style="width: 100%;">
        <tr>
            <td style="background-color: #293A27">
                <span class="style2">Complain Candidate </span>&nbsp; &nbsp; &nbsp;
            </td>
        </tr>
        <tr>
            <td >
...
<asp:Label ID="lblNoDataMsg" runat="server" 
                ...
                <asp:GridView ID="_gvReport" runat="server" AutoGenerateColumns="False" 
                    style="text-align: center; font-size: small" Width="102%">
                    <Columns>
                        <asp:BoundField DataField="Cand_No" HeaderText="Candidate No" />
                        <asp:BoundField DataField="Cand_Name" HeaderText="Candidate Name" />
